...
namespace StringArray
{
    class Program
    {
        ...
        {  
            ...
            Console.WriteLine("  1. Convert the 10 amendment into a string array");
            Console.WriteLine("  2. Loop through the array and print each amendment");
            Console.WriteLine("  3. Find the amendment that contains the world 'controversy'");
            Console.WriteLine("  4. find the longest amendment");
            ...
            {
                case 1: 
                Console.WriteLine("Convert the 10 amendment into a string array");
                break;
                case 2:
                Console.WriteLine(" Print each amendment");
                break;
                case 3:
                Console.WriteLine("Find the amendment that contains the world 'controversy'");
                break;
                case 4:
                Console.WriteLine("find the longest amendment");
                break;
                default:
